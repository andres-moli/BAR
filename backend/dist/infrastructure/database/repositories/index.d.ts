...
import { UserEntity, TableEntity, ProductEntity, OrderEntity, OrderItemEntity, PaymentEntity, ClientEntity, CollectionAccountEntity, CollectionPaymentEntity, CategoryEntity, AccountEntity, PaymentMethodEntity, CashRegisterEntity, CashMovementEntity } from '../../../domain/entities/index';
...
export declare class PrismaTableRepository implements ITableRepository {
    ...
    findByStatus(status: any): Promise<TableEntity[]>;
    create(data: {
        number: number;
        capacity?: number;
        location?: string;
    ...
    delete(id: string): Promise<void>;
    updateStatus(id: string, status: any): Promise<TableEntity>;
}
...
export declare class PrismaOrderRepository implements IOrderRepository {
    ...
    findByTable(tableId: string, status?: any): Promise<OrderEntity[]>;
    ...
    findOrderItem(id: string): Promise<any | null>;
...
export declare class PrismaClientRepository implements IClientRepository {
...
export declare class PrismaCollectionAccountRepository implements ICollectionAccountRepository {
    findAll(filters?: {
        status?: string;
        clientId?: string;
    ...
    delete(id: string): Promise<void>;
    findWithPayments(id: string): Promise<any | null>;
}
export declare class PrismaCollectionPaymentRepository implements ICollectionPaymentRepository {
...
export declare class PrismaCashRegisterRepository implements ICashRegisterRepository {
